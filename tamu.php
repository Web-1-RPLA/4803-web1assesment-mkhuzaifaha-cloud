    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        <table>
            ...
            <tr> 
                ...
                <td><a href="edittamu.php?id=<?php echo $row['id']; ?>">Edit</a> 
                </br/><a href="hapustamu.php?id=<?php echo $row['id']; ?>">Hapus</a></td>
            </tr>
            <?php
            }
            ?>
        ...
        echo '<div class = "empty message"> Data tamu kosong</div>';
    }
        ?>
